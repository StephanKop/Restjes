  ...
  return (
    <aside className="fixed left-0 top-0 z-40 flex h-screen w-60 flex-col bg-sidebar">
      ...
      <div className="flex h-16 items-center gap-2 border-b border-white/5 px-5">
        <Image src="/logo.png" alt="Kliekjesclub" width={160} height={160} className="h-12 w-auto brightness-0 invert" />
      ...
      <div className="border-t border-white/5 px-5 py-4">
        <p className="text-xs text-gray-500">Kliekjesclub Admin v0.1</p>
      </div>
    </aside>
  )
}
